...
import { FrappeContext, useFrappeGetDocCount, useFrappeGetDocList, useFrappePostCall, useSWRConfig } from "frappe-react-sdk"
...
const ReconcileProgress = () => {
    ...
    const { data: totalCount } = useFrappeGetDocCount<number>('Bank Transaction', [
