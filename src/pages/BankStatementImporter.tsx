...
const BankStatementImporter = () => {
    ...
    const onUpload = () => {
        ...
        upload(files[0], {
            ...
            navigate({ to: '/statement-importer/$id', params: { id: doc.name } })
        })
    }
...
const StatementImportLog = () => {
    ...
    const onViewDetails = (name: string) => {
        navigate({ to: '/statement-importer/$id', params: { id: name } })
    }
        ...
        <div className="flex flex-col gap-4">
            ...
            {data && data.length > 0 ? (
                ...
                <Table>
                    ...
                    <TableBody>
                        {data?.map((item: BankStatementImportLog) => (
